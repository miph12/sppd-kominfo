...
if(isset($_POST['update'])){
    ...
    $query =mysql_query("UPDATE tb_pegawai set 
                            ...
                            where kode_pegawai=$kodepegawai") or die(mysql_error());
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Perbaharui Data Pegawai</h1>
			</div>
		</div><!--/.row-->
				
		<div class="panel panel-default">
		<div class="panel-heading" align="center">Form Edit Data Pegawai</div>
							...
							<form class="form-horizontal"  method="post">
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
										<input id="name" name="kodepegawai" type="text" placeholder="Masukkan Kode" class="form-control" value="<?php  echo $data['kode_pegawai']; ?>">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
										<input id="name" name="namapegawai" type="text" placeholder="Masukkan Nama Pegawai" class="form-control" value="<?php  echo $data['nama_pegawai']; ?>">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
										<input id="name" name="nip" type="text" placeholder="Masukkan Nomor Induk Pegawai" class="form-control" value="<?php  echo $data['nip']; ?>">
										</div>
									</div>
									<div class="form-group">
