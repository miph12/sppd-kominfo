...
if (isset($_POST['simpan'])) {
  ...
  $namajabatan =  addslashes($_POST['namajabatan']) ;
      ...
      $insert = mysql_query("INSERT INTO tb_pegawai(  kode_pegawai, nama_pegawai, nip,  kode_golongan, kode_jabatan)
      ...
      if ($insert) {
	    ...
	    echo '<meta http-equiv="refresh" content="tambahpegawai.php">';
	  }
							...
							<form class="form-horizontal"  method="POST">
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
										<input id="name" name="namapegawai" type="text" placeholder="Masukkan Nama Pegawai" class="form-control" required>
										</div>
